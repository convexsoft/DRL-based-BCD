...
my_list = list()
df=pd.read_csv('lr.csv', header=None, sep=',')
...
arr4 = moving_average(interval = arr4, window_size = 1)
...
fontsize = 16
axis_size = 10
label = ["learning_rate = 1e-4","learning_rate = 1e-5","learning_rate = 1e-6","learning_rate = 1e-7"]
